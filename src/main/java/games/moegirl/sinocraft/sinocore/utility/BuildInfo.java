...
public class BuildInfo {
    ...
    static {
        ...
        try {
            ...
            full_version = properties.getProperty("full_version");
    ...
    public static void printBuildInfo() {
        LOGGER.info("SinoCore Version: {} (Commit {}), Build at: {}", FULL_VERSION, COMMIT_ID, BUILD_TIME != null ? BUILD_TIME : "B.C. 3200");
    }
}
