...
@Getter
public class ProgressEntry extends AbstractWidgetEntry {
    public static final MapCodec<ProgressEntry> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
