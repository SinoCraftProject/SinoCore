package games.moegirl.sinocraft.sinocore.fabric.event.client.model;
...
public class ModelEventImpl implements ModelLoadingPlugin {
    ...
    public void onInitializeModelLoader(Context pluginContext) {
        pluginContext.modifyModelAfterBake().register(((model, context) ->
                ModelEvents.AFTER_BAKE.invoke(new AfterBakeArgs(context.loader(), context.topLevelId(), model)).getModel()));
    }
}
